...
const ALL_35_TABLES = [
  ...
  { table: 'asset_categories', expected: '>= 6', class: 'A. REQUIRED MASTER DATA' },
  { table: 'assets', expected: '>= 5', class: 'A. REQUIRED MASTER DATA' },
  { table: 'asset_history', expected: '>= 2', class: 'C. EXPECTED EMPTY — TRANSACTIONAL' },
  { table: 'asset_maintenance', expected: '>= 0', class: 'C. EXPECTED EMPTY — TRANSACTIONAL' },
