...
INSERT INTO leave_types (id, organization_id, name, code, annual_quota, is_paid)
VALUES 
('70000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Casual Leave', 'CL', 12, TRUE),
('70000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Sick Leave', 'SL', 12, TRUE),
('70000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'Earned / Privilege Leave', 'EL', 15, TRUE),
('70000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'Optional Holiday Leave', 'OL', 3, TRUE)
ON CONFLICT (code) DO NOTHING;
