...
export const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  // Close notification panel automatically when navigating routes
  useEffect(() => {
  ...
  return (
    <>
      {/* ─── DESKTOP HEADER (>= 1024px) - Preserved Unchanged ─── */}
      ...
      <header className="lg:hidden sticky top-0 z-50 flex items-center justify-between h-14 px-4 bg-sky-600 text-white shadow-md">
